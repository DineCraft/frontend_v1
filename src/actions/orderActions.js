...
export const getStatistics = () => async (dispatch, getState) => {
    try {
        ...
        //get all sales
        const { data } = await axios.get(`http://localhost:3005/api/orders/statistics`, config);
...
export const listOrders = (options) => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(
            `http://localhost:3005/api/orders/?keyword=${keyword}&pageNumber=${pageNumber}${
...
export const createOrder = (order) => async (dispatch, getState) => {
    try {
        ...
        //create order
        const { data } = await axios.post("http://localhost:3005/api/orders", order, config);
        dispatch({
...
export const listOrderDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:3005/api/orders/${id}`, config);
        dispatch({
...
export const updateOrder = (order) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            `http://localhost:3005/api/orders/${order.id}`,
            order,
            config
        );
        dispatch({
...
export const updateOrderToPaid = (order) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(
            `http://localhost:3005/api/orders/${order.id}/pay`,
            order,
            config
        );
        dispatch({
...
export const deleteOrder = (id) => async (dispatch, getState) => {
    try {
        ...
        await axios.delete(`http://localhost:3005/api/orders/${id}`, config);
        dispatch({
